...
Qt 则逐渐走得更“大而全”。它自己提供大量抽象，因此不仅能做 Windows/Linux/macOS 桌面软件，还越来越深入嵌入式、车载、工业控制等场景。所以 2000 年之后，Qt 的定位已经逐渐不是单纯：和 MFC 一样的 GUI 库。而更接近C++ 应用程序开发平台。
